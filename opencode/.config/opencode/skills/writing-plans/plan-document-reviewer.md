...
**Purpose:** Verify the plan is complete, aligns with the design, and has proper task decomposition.
...
Agent tool (general-purpose):
  ...
  prompt: |
    ...
    **Design for reference:**
    ...
    [PASTE THE FULL DESIGN SUMMARY FROM THE BRAINSTORMING CONVERSATION HERE]
