...
Use `{{DISPATCH_AGENT_TOOL}}` with a code-reviewer type, fill template at `code-reviewer.md`
...
[Dispatch code-reviewer subagent]
  ...
  PLAN_OR_REQUIREMENTS: Task 2 from /tmp/plans/deployment-plan.md
  BASE_SHA: a7981ec
  HEAD_SHA: 3df7661
...
**Never:**
- Skip a review because "it's simple"
...
See the template at: requesting-code-review/code-reviewer.md
