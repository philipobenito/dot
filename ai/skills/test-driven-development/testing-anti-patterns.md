...
3. If yes, mock at a lower level that preserves the needed behaviour.
...
Tests are part of implementation, not optional follow-up. TDD cycle: write failing test, implement to pass, refactor, then claim complete.
