...
- Fails because a feature is missing (not typos)
...
Bug found? Write a failing test reproducing it. Follow the TDD cycle. Test proves a fix and prevents regression.
